...
class BundleTrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return torch.LongTensor([user_b]), torch.LongTensor(all_bundles) #user & pos & neg bundles
...
class Datasets():
    def __init__(self, conf):
        ...
        self.train_loader = DataLoader(self.bundle_train_data, batch_size=batch_size_train, shuffle=True, num_workers=10, drop_last=True) #drop_last：抛弃最后小于batch_size部分的数据
